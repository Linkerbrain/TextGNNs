...
word_word_caps = [10 + 15 * i for i in range(1, 20)]
for ww_cap in word_word_caps:
    models.append(
    {
        "test_name" : "%i WordWordCap" % ww_cap,
        "graph_method" : {
            "name" : "pmi_tfidf",
            "kwargs" : {
                "window_size" : 10,
