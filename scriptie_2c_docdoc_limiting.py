...
base_config = {
    ...
    "experiment_name" : "scriptie_2c_local",
    "ductive" : "trans",
    "initial_repr" : "onehot",
...
models = [
    {
        ...
        "graph_method" : {
            ...
            "kwargs" : {
                ...
                "average_docdoc_conns" : 10,
            }
        },
    },
    {
        "test_name" : "No DocDoc Connections",
        "graph_method" : {
            "name" : "pmi_tfidf",
            "kwargs" : {
                "window_size" : 10,
...
# quick & ugly solution for a lot of tests
doc_doc_caps = [20, 30, 40, 50, 75, 100, 125, 150, 175, 200]
for dd_cap in doc_doc_caps:
    models.append(
    {
        "test_name" : "%i DocDocCap" % dd_cap,
        "graph_method" : {
            "name" : "pmi_tfidf",
            "kwargs" : {
                "window_size" : 10,
